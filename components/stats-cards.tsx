        ...
        return [
          {
            ...
            metricValue: "300",
            metricUnit: "kcal",
            progress: Math.min((stats.total_calories / 300) * 100, 100),
            trophyColor: "text-amber-800",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_calories / 300) * 100, 100)),
          },
          {
            title: "Meta Prata",
            metricValue: "600",
            metricUnit: "kcal",
            progress: Math.min((stats.total_calories / 600) * 100, 100),
            trophyColor: "text-gray-400",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_calories / 600) * 100, 100)),
          },
          {
            title: "Meta Ouro",
            metricValue: "900",
            metricUnit: "kcal",
            progress: Math.min((stats.total_calories / 900) * 100, 100),
            trophyColor: "text-amber-400",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_calories / 900) * 100, 100)),
          },
          {
            title: "Meta Diamante",
            metricValue: "1500",
            metricUnit: "kcal",
            progress: Math.min((stats.total_calories / 1500) * 100, 100),
            trophyColor: "text-blue-500",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_calories / 1500) * 100, 100)),
          },
        ]
        ...
        return [
          {
            ...
            metricValue: "30",
            metricUnit: "minutos",
            progress: Math.min((stats.total_running / 30) * 100, 100),
            trophyColor: "text-amber-800",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_running / 30) * 100, 100)),
          },
          {
            title: "Meta Prata",
            metricValue: "90",
            metricUnit: "minutos",
            progress: Math.min((stats.total_running / 90) * 100, 100),
            trophyColor: "text-gray-400",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_running / 90) * 100, 100)),
          },
          {
            title: "Meta Ouro",
            metricValue: "180",
            metricUnit: "minutos",
            progress: Math.min((stats.total_running / 180) * 100, 100),
            trophyColor: "text-amber-400",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_running / 180) * 100, 100)),
          },
          {
            title: "Meta Diamante",
            metricValue: "300",
            metricUnit: "minutos",
            progress: Math.min((stats.total_running / 300) * 100, 100),
            trophyColor: "text-blue-500",
            bottomTitle: "Resgatar Recompensa",
            bottomContent: createRedemptionButton(Math.min((stats.total_running / 300) * 100, 100)),
          },
        ]
    }
  }
